...
function Businesses() {
  ...
  async function remove(m: Merchant) {
    // Delete storage assets referenced by photos
    ...
    if (paths.length) await supabase.storage.from('merchant-assets').remove(paths);
    ...
    toast.success('Deleted'); qc.invalidateQueries({ queryKey: ['admin-businesses'] });
  }
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>This removes the business, all photos (including storage files), and opening hours. This cannot be undone.</AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
