...
// Opening Hours now lives as a section inside the unified My Business page.
...
export const Route = createFileRoute('/merchant/_authenticated/hours')({
  component: HoursRedirect,
});

function HoursRedirect() {
  const navigate = useNavigate();
  useEffect(() => {
    navigate({ to: '/merchant/my-business', hash: 'section-hours', replace: true });
  }, [navigate]);
